...
Решение: реализация подобия мьютекса. Если один из запросов инициализировал запрос на рефреш токена, то остальные ждут, пока он не выполнится. И как только запрос завершится, остальные продолжат свою работу.
