...
import {
  ButtonBase, Avatar, SvgIcon, FlexContainer, FlexItem,
} from '@astral-frontend/components';
import { withStyles } from '@astral-frontend/styles';
import { ArrowIcon } from '@astral-frontend/icons';

const DashboardLayoutOrganizationSelectorCurrentOrganization = React.forwardRef((props, ref) => {
  const {
    classes, className, name, ...rest
  } = props;

  return (
    <FlexContainer component={ButtonBase} ref={ref} className={cn(classes.root)} {...rest}>
