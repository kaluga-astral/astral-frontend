...
describe('` mustBePresent` validation rule', () => {
  test('should return an error object if value is invalid', () => {
    expect(mustBeDatePeriod('1000', '2019', '2017')).toEqual('Дата имеет недопустимое значение');
    expect(mustBeDatePeriod('1000', '0001', '2017')).toEqual('Дата имеет недопустимое значение');
  });
